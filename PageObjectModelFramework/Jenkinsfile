    ...
    stages {
        ...
        stage('Clean Workspace') {
            steps {
                ...
                bat '''
                    if exist PageObjectModelFramework\\reports rmdir /s /q PageObjectModelFramework\\reports
                    if exist PageObjectModelFramework\\screenshots rmdir /s /q PageObjectModelFramework\\screenshots
                    if exist PageObjectModelFramework\\logs rmdir /s /q PageObjectModelFramework\\logs
                    
                    mkdir PageObjectModelFramework\\reports
                    mkdir PageObjectModelFramework\\screenshots
                    mkdir PageObjectModelFramework\\logs
